...
BGP preferences, and static routes that satisfy all the given \loris{control-plane?} policies---e.g.,
...
compute very precise costs for a given domain assignment, but they are very expensive ones.
In fact, Theorem~\ref{} shows that, even for a single domain, computing accurate costs---e.g., number or
