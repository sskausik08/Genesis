...
\begin{figure*}
	...
	\hfill
	\subfloat[Ex2]{\includegraphics[width=0.66\columnwidth]{figures/bgp-example2.pdf}}
	\hfill
	\subfloat[Ex3]{\includegraphics[width=0.53\columnwidth]{figures/static-route.pdf}}
