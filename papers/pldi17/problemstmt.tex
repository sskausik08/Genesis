...
by $r_1$ with a local preference value will be 
advertised to the rest of the BGP routers of the 
domain as an iBGP route. We can configure iBGP 
...
describe how routing happens across domains.
