...
uses LP-solvers (which are faster and parallelizable) 
to tackle configuration
synthesis rather than SMT solvers.
Their approach does not deal with resilience, 
...
where some routers only run OSPF and not BGP. Our MCMC algorithm can
