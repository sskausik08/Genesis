...
Thus, a constraint of the form $D(r_\beta,t) \leq E$---where 
$E$ is some expression---will not impose any restriction
on the value of $D(r_\beta,t)$ (thus, not affecting $W$ which depends
on $D(r_\beta,t)$). 
