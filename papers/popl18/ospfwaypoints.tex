...
distances and may not be equal\loris{equal to what?}, thus, the term $D(r_\beta,t)$ 
will not faithfully represent the distance \loris{distance from where to where}  as the constraint is simply 
imposing an upper bound on an upper bounded variable. \loris{what is an upper bounded variable?} 
