\loris{All the theorems are just soundness not correctness}
...
\begin{theorem}[Correctness]
	...
	each packet class, the shortest path  \loris{from where to where?}
...
\begin{proof}
	...
	$\forall w \in \waypt.~w \not\in \sigma_{pc}$ \loris{doesn't typecheck, $\sigma_{pc}$ is a list of links not a set}. 
