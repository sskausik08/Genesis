...
\input{bgp-routing-algorithm} 
 ...
 \loris{make notation uniform in algo one, some comments are not in bracket and I'm not sure what's a comment}
...
to disallow traffic blocked by policies \loris{add citation}. Supporting access control policies 
