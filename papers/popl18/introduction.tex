...
\loris{maybe one sentence about beating vechev}
\kausik{\name's performance is 2-3 orders of magnitude faster than
the state-of-the-art network configuration synthesis tools~\cite{synet}.
[Dont know where to place this line.]}

\aditya{edited till here. will get back tomorrow AM}
