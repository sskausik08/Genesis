...
avoid deployment of resource-intensive protocols such as BGP on a
large fraction of routers.
...
enable generation of simple-to-manage network
configurations. \aditya{update citations to most recent versions;
  e.g., CAV paper}
...
different domains so that the synthesized configurations have even
