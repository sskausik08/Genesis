...
simple-to-manage network configurations. \aditya{update citations to
  most recent versions; e.g., CAV paper}
...
\aditya{we need a para here about experiments and results, instead of
  the one sentence about vechev comparison.}

\loris{maybe one
  sentence about beating vechev} \kausik{\name's performance is 2-3
  orders of magnitude faster than the state-of-the-art network
  configuration synthesis tools~\cite{synet}.  [Dont know where to
    place this line.]} 
...
\begin{itemize}	
	...
	\item An implementation of \name together with an evaluation
          ...
          \aditya{FILL THE REST. vechev comparison summary and perhaps
            main quantitative takeaway from expts} \aditya{the
            following sentence is repetitive and content-free without
            any quantitative info. nix} Our results show that \name
