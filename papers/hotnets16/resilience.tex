...
we have a name for this?} \kausik{We havent considered ``always blocked''.
We were thinking of including it in the discussion as "Default off" network
like SDNs}
...
\kausik{Is there a way
to repair ARCs to increase max-flow. Actually, the max-flow property is 
integrated in the ARC synthesis, so we may not need to do it here}
