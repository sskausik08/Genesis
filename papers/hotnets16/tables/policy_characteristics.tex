...
\botcompactcaption{Graph characteristics an \ARC must satisfy to ensure backup paths
are policy compliant under up to $k$ link failures}
%; policies and characteristics are inspired by Gember-Jacobson et. al \protect\cite{arc}}
\end{table}
