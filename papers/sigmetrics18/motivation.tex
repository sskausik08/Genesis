\section{Background on distributed control planes} \label{sec:motivation}
...
%\todo{Why is the following section needed at all? I think it should be consolidated with 
%intro}
...
\todo{Fix all citations that don't have year}: operators can specify what
...
%
%\todo{before I rewrite the following paragraph want to know if we need this
%section at all}
