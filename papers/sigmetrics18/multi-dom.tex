...
can lead to explosion of OSPF routing tables. However, 
in our datacenter setting, BGP is used in a restricted
sense for management ease and BGP routers are not connected
to the external internet directly. We manually enable iBGP route redistribution~\cite{ibgprouteredist} for internal prefixes to
prevent the explosion of routing tables from external prefixes.
...
route for $\lambda$ from $g_2$, and therefore,
...
\begin{figure*}
	\centering
	\subfloat[Single
	BGP Gateway]{\includegraphics[width=0.305\textwidth]{figures/bgp-example.pdf}}
	\hfill
	\subfloat[Multiple BGP Gateways]{\includegraphics[width=0.31\textwidth]{figures/bgp-example2.pdf}}
	\hfill
	\subfloat[Static Routes]{\includegraphics[width=0.265\textwidth]{figures/static-route.pdf}}
