...
\kausik{
The algorithm we presented in the previous section generates configuration which guarantees enforcement of complex policies under 
no failure scenarios, and at the same time achieves good
connectivity resilience by using fewer static routes as possible.
...
uses \genesis to generate two link-disjoint paths which traverse through
