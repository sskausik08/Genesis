\begin{proof}
	...
	\minisection{Case 1:} $\paths^C(pc) = \emptyset$---i.e., there
	...
	\minisection{Case 2:} All paths in $\paths^C(pc)
...
\begin{description}
	...
	\begin{description}
			...
			\item[Case 2A.2:]
			$\sigma_{pc}$ has a static route on the path. Since, \Cref{alg:wayptunsat}
