...
To support policy routing  \todo{What is policy routing?}, BGP routers can be configured with a
...
and map each reachability/waypoint \todo{remove  reachability/waypoint , say something
policy-agnostic} policy (which produce paths) 
