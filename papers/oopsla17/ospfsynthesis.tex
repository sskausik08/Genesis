...
\loris{need to argue that minimizing static routes is the right thing to do and then
show the hardness result}
...
Equations~\ref{eq:distance} guarantees that $D_{s}^{t}$ is smaller or equal to
...
\end{equation}
Equations~\ref{eq:unique} guarantee that 
