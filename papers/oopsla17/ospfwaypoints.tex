...
\loris{the definition is now in sec 3, rewrite this to just
use the notion of policy compliance and just say 
we want to maximize, so we don't have to worry about soundness
completenss}
