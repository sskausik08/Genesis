...
satisfies the waypoint policy. Our constraints need to
guarantee that the path provided by \genesis is shorter
than any path which does traverse the waypoint. 
...
\minisection{Avoiding Routing Loops} \label{sec:loopavoidance}
