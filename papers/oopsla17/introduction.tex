...
policies (e.g., peering) and \loris{do not attempt to be resilient to failures}.



The problem of synthesizing router configurations
for which the distributed control plane 
\loris{is fault-tolerant and it}
...
\loris{Third, to generate resilient control planes one has to reason
...
Third,  we consider a setting in which the operator has the flexibility to
