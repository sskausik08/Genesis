...
%% different departments imposing different sets of policies.
 ...
 \Cref{fig:architecture} shows several tenants who
...
\minisection{Tenant Policy: Reachability}. This enables network communication
...
\minisection{Tenant Policy: Middlebox Traversals}. A tenant may wish that the flow
...
\minisection{Tenant Policy: Isolation}. Tenants may require various
...
\minisection{Operator Policy: Managing Capacity Constraints}. While
  ...
  uses). In our example in \Cref{fig:architecture}, A2-C2 and A4-C2
...
\minisection{Operator Policy: Traffic Engineering}. As an alternative to
...
\minisection{Operator Policy: Handling failure gracefully}. Modern
...
(\secref{sec:optimization}).  Finally, we describe two novel techniques aimed at
