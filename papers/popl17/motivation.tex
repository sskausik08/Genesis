...
datacenter, \sout{which could be either a public datacenter (E.g., Azure),}
...
%% different departments imposing different sets of policies.
 ...
 control reasons. 
 \kausik{Given the policies, the cloud operator 
...
\item \textbf{Operator Policy: Managing Capacity Constraints}. While
  ...
  carefully manage constrained resources\footnote{
  \kausik{
  This can also be used to provide QoS guarantees to tenants like minimum
  ...
  (\texttt{A2 $\rightarrow$ C2: 100, A4 $\rightarrow$ C2:100}).
