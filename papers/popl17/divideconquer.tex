...
Since the complexity of finding a
...
\begin{algorithm}[t]
	...
	\begin{algorithmic}[1]
		...
		\State{$sol_2$ = Apply synthesis on $P_2$ such that \newline \hspace*{2cm} $sol_1 \cup sol_2$ is a solution for P}
...
We use the \emph{min-cut} to partition the policy graph
