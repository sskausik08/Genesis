...
plt.grid()
plt.savefig('noTacticIsolation0.png', format='png', dpi=1000, bbox_inches='tight')

noTacticFig = plt.figure(2)
...
plt.grid()
plt.savefig('noTacticIsolation1.png', format='png', dpi=1000, bbox_inches='tight')

noTacticFig = plt.figure(8)
...
plt.plot(x, noTactic10, '#984ea3', marker="s", markersize=markersize, label="Baseline")
...
plt.grid()
plt.savefig('Isolation0.png', format='png', dpi=1000, bbox_inches='tight')

noTacticFig = plt.figure(3)
...
plt.plot(x, noTactic10, '#984ea3', marker="s", markersize=markersize, label="Baseline")
plt.plot(x, edgeTactic10, '#ff7f00', marker="o", markersize=markersize, label="No Edge Tactic")
...
plt.grid()
plt.savefig('Isolation1.png', format='png', dpi=1000, bbox_inches='tight')


noTacticFig = plt.figure(7)
...
plt.plot(x, noTactic10, '#984ea3', marker="s", markersize=markersize, label="Baseline")
plt.plot(x, edgeTactic10, '#ff7f00', marker="o", markersize=markersize, label="No Edge Tactic")
plt.plot(x, noValleyTactic10, '#4daf4a', marker="D", markersize=markersize, label="Valley-Free Tactic")
...
plt.grid()
plt.savefig('Isolation2.png', format='png', dpi=1000, bbox_inches='tight')
...
plt.grid()
plt.savefig('isolationTopology0.png', format='png', dpi=1000,  bbox_inches='tight')

isolationTopologyFig = plt.figure(5)
noTactic = [0.0122,0.0804,2.0785,9.6241]
noEdge = [0.0086,0.05433333333,0.2631666667,2.58618]
len7 = [0.007133333333,0.043,0.2188333333,1.0793]
len7noEdge = [0.007133333333,0.044,0.2468333333,1.0075]
...
plt.grid()
plt.savefig('isolationTopology1.png', format='png', dpi=1000,  bbox_inches='tight')

isolationTopologyFig = plt.figure(6)
noTactic = [0.0122,0.0804,2.0785,9.6241]
noEdge = [0.0086,0.05433333333,0.2631666667,2.58618]
len7 = [0.007133333333,0.043,0.2188333333,1.0793]
len7noEdge = [0.007133333333,0.044,0.2468333333,1.0075]
...
plt.grid()
plt.savefig('isolationTopology2.png', format='png', dpi=1000,  bbox_inches='tight')
...
noTacticFig = plt.figure(10)

repair = [0.7,1.7,4.5,7.1,10.9,30.6,219]
groundup = [0.4372241497,1.165225983,2.570262909,4.928798914,6.639307022,453,2353.869107]

markersize = 11

plt.plot(x, groundup, '#984ea3', marker="s", markersize=markersize, label="Synthesis")
#plt.plot(x, noTactic1, '#ff7f00', marker="o", markersize=markersize, label="Group Size:1")
...
plt.xlabel('Number of Paths', fontsize=20)
plt.ylabel('Time (log s)', fontsize=20)

plt.grid()
plt.savefig('repair0.png', format='png', dpi=1000, bbox_inches='tight')

noTacticFig = plt.figure(11)
...
plt.plot(x, groundup, '#984ea3', marker="s", markersize=markersize, label="Synthesis")
plt.plot(x, repair, '#ff7f00', marker="o", markersize=markersize, label="Repair")
...
plt.grid()
plt.savefig('repair1.png', format='png', dpi=1000, bbox_inches='tight')