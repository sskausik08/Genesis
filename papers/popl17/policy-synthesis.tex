...
model the forwarding and reachability relations using propositions and
 ...
 and isolation to a Boolean Satisfiability Problem (SAT) problem.
% \footnote{
...
the neighbors of $s$\footnote{
	...
	clauses $\vee_{n \in N(s)}$ and
	the universal quantifier $\forall n \in N(dst)$ using conjunction of clauses $\wedge_{n \in N(dst)}$
