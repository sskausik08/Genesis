...
\subsubsection{Ordered Waypoints}
While our network model intuitively supports unordered waypoints, sometimes, operators may require support for waypoints in a particular order. Let us assume the waypoints in order are $w_1 w_2 \ldots w_n$. 
