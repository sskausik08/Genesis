...
\end{equation}
For the relative ordering among sets, we need to all the following constraints which ensure that all waypoints
...
\end{equation}
The $|A|$ function is used to the denote the size of set $A$. The constraint on the forwarding set are that the size of each set must not exceed 1 (0 or 1). The forwarding set constraints\footnote{
