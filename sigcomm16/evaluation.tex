...
%\begin{figure*}
%	\centering
%	\subfloat[subcaption 1]{\includegraphics[width=0.66\columnwidth]{figures/no-tactic-isolation-plot.png}}
%	\subfloat[subcaption 2]{\includegraphics[width=0.66\columnwidth]{figures/no-tactic-isolation-plot.png}}
%	\subfloat[subcaption 3]{\includegraphics[width=0.66\columnwidth]{figures/no-tactic-isolation-plot.png}}
...
\begin{figure*}
		\centering
		\subfloat[No Edge Tactic]{\includegraphics[width=\columnwidth]{figures/no-edge-tactic-isolation-plot.png}}
		\subfloat[Valley-free Routing Tactic]{\includegraphics[width=\columnwidth]{figures/eacae-isolation-plot.png}}
