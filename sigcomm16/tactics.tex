...
as follows which say that a switch with label $l$ has to be the destination and cannot precede a switch: 
...
to ensure that switch with label $l_2$ reached after $i + 2$ steps is not preceded by a switch of label $l_1$ : 
