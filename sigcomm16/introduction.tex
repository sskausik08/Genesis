...
By leveraging the formal guarantees of constraint solving,
...
order of seconds. This raises the need for better search strategies.  
To this
...
a 1.5x-400x speedup for different workloads.
 ...
 Secondly, \Name can use a heuristic synthesis procedure termed as
 ...
 premise of this synthesis procedure is to partition the input isolation
...
\item \Name, an extensible declarative framework for describing complex policies that can
...
\item Tactics, which leverage the network structure to blacklist undesirable path 
patterns. Tactics are specified using a restricted form of regular expressions and
act as a search strategy for the solver and vastly reduce the number of generated constraints.
