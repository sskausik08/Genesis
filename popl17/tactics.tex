...
Contradiction, as $\pi \models \neg (l_{src}\ .^i \ .^* \ l_{dst})$. Hence, our assumption is incorrect.
 \newline 
  \newline 
 \textbf{Type 2}: $\neg (l_{src} .^i \ l \ .^* l_{dst})$ \newline
 ...
 Contradiction, as $\pi \models \neg (l_{src} .^i \ l \ .^* l_{dst})$. Hence, our assumption is incorrect.
  \newline  
  \newline
  \textbf{Type 3}: $\neg (l_{src} .^i \ l_1 \ l_2 \ .^* l_{dst})$ \newline
   ...
   Contradiction, as $\pi \models \neg (l_{src} .^i \ l_1 \ l_2 \ .^* l_{dst})$. Hence, our assumption is incorrect.
\end{proof}
