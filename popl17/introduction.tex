...
We argue that data plane synthesis can offer a practical
...
slow synthesis speeds (up to several minutes in the median case;
\secref{sec:baselineeval}) which can be impractical.
