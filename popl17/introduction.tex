...
In this paper, we seek a {\em general} and {\em automated}  
approach that allows a variety
of rich policies to be specified in a simple and declarative way as the input,
and the output is the set of switch forwarding rules such 
...
multi-tenant networks. \kausik{One of the reviewers had a problem
	here, I dont know what concrete data to put, as tactics do not
	reduce the order of synthesis time.}
