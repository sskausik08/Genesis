...
machines communicating (flows) on a network with many heterogeneous devices. With growing
diversity of tenant applications, need for security and compliance,
and the advent of cloud computing, the pathways of communication
...
centralized controller machine (control plane) manages a collection of
...
some of these policies (enforcing isolation
is NP-complete),
\Name 
...
\item An extensible declarative framework for describing
  ...
  like isolation, waypoints, and traffic engineering (\secref{sec:synthesisalgo});
