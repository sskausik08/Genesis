...
a solution to the constraints. \aditya{should we say something about
  maxsmt and failure. this is the only para here talking about
  sections 2--5 of the paper} The solution is then translated into
