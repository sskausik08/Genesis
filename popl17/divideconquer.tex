...
We use the following scheme to partition the policy graph connected component into two: 
\emph{min-cut} partitioning, which partitions the graph
...
the graph into two \emph{equal sized} partitions and minimizing the cut edges
