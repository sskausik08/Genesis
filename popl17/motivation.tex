...
it's only role is to install the forwarding rules to the switches.
...
\kausik{Does a point about resilience fit in the context? We are 
	trying to motivate why we use synthesis, resilience can 
	be considered as a special policy.}
