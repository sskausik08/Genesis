...
%and $A2 \rightarrow C4$ do not exceed the link capacity of 100.
 ...
 operator requires to find new forwarding rules such that policies are
 ...
 sets up connections with switches and sends the new rules). Thus,
 minimal network repair tries to minimize 
 the overhead of transitioning from a
 old data-plane to a new policy-compliant one. While repair
 is a reactive approach to failures, configuring switches proactively
