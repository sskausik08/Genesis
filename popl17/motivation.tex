...
policies about the paths among it's hosts. \Cref{fig:architecture} shows several tenants
...
\item \textbf{Middlebox Traversals}. A tenant may wish that traffic
  ...
  specific middleboxes for %(locations, or logical descriptors) for
  ...
  \Cref{fig:architecture} defines a waypoint policy $V1 >> FW;
...
\item \textbf{Network Resource Management}. While support for the
  ...
  certain links. For example, in \Cref{fig:architecture}, A2-C2 and A4-C2
