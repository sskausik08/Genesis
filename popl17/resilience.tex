...
However, upon the failure of a link, {\em reactively} synthesizing 
a new data plane which satisfies
...
rules for every network failure event.
...
to under-provisioning of resources. Presently, the resilience
