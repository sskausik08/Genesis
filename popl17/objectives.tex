...
for traffic engineering. We conclude by describing how \Name can be
extended to allow operators to handle datacenter network failures
gracefully.

\subsection{Link and Switch Table Capacity Constraints} \label{sec:linkcap}
%%\subsubsection{Link Capacity Constraints} 

As with policies, \Name uses propositional logic and LRA to accommodate hard
constraints on link and switch table capacities.
...
minimizing the total link utilization or the maximum link utilization. To support such optimization objectives
\Name uses extensions of solvers with support for linear optimization
objectives.
