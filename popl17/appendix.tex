...
\end{theorem}
\begin{proof}
	\textbf{Assume} $\exists (R,pc) \in \Gamma$ and $(\pi, pc) \in \Pi$ and $\Phi(\pi) \not\in L(R)$
	...
	However, $(Fwd, Reach) \models \Psi_T(R, pc) \Leftrightarrow (Fwd, Reach) \models \forall sw,k \geq i + 1. (sw,pc,k) \notin Reach$.\\
	...
	However,
	$(Fwd, Reach) \models \Psi_T(R, pc) \Leftrightarrow (Fwd, Reach) \models \forall sw.~ \phi(sw) = l ~\wedge~ sw \not= dst \implies  (sw, pc, i + 1) \notin Reach$. \\
	...
	However,
	$(Fwd, Reach) \models \Psi_T(R, pc) \Leftrightarrow (Fwd, Reach) \models \forall n_1, n_2.~\phi(n_1) = l_1~\wedge~ \phi(n_2) = l_2 ~\wedge~ n_2 \not=dst  \implies 
...
\end{theorem}
\begin{proof}
	\textbf{Assume} $\exists (R, pc) \in \Gamma$ such that $(Fwd, Reach) \not\models \Psi_T(R,pc)$.
	Consider the three types of tactics for $R$: \newline
	\textbf{Type 1}: $R = \neg (l_{src} .^i .^* l_{dst})$ \newline
	$(Fwd, Reach) \not\models \Psi_T(R, pc)$ $(Fwd, Reach) \not\models \forall sw,k \geq i + 1. (sw,pc,k) \notin Reach$ \newline
