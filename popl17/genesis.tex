...
\documentclass[9pt,numbers,preprint,nocopyrightspace]{sigplanconf}
...
\usepackage{titlesec}
\titlespacing*{\section}{1pt}{3pt}{1pt}
\titlespacing*{\subsection}{0.1pt}{2pt}{0.1pt}
...
\iffull
\title{Genesis: Automatic Synthesis of Switch Forwarding Rules  in Multi-Tenant Networks}
\else
\title{Genesis: Automatic Synthesis of Switch Forwarding Rules  in Multi-Tenant Networks}
\fi
